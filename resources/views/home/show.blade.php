    ...
    <div class="row">
        <div class="col-md-6 mb-3 mb-md-0">
            ...
            <div class="mb-4">
                ...
                <span class="badge text-bg-light border shadow-sm">Keluar : {{
        ...
        <div class="col-md-6">
            <h5 class="mb-3">History 30 Hari Terakhir</h5>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>@if($histo->presence_out_time)
                                ...
                                @else
                                <span class="badge text-bg-danger">Belum Absensi Keluar</span>
                                @endif
                            </td>
                            <td>
